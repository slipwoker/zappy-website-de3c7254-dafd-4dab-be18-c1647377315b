    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            if (e.target.matches('input, textarea, select')) {
                const existing = e.target.parentElement.querySelector('.form-error');
                if (existing) validateField(e.target);
            }
        });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'de3c7254-dafd-4dab-be18-c1647377315b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'de3c7254-dafd-4dab-be18-c1647377315b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'de3c7254-dafd-4dab-be18-c1647377315b';
